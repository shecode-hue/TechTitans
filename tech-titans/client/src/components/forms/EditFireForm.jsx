      ...
      <div className="container">
        ...
        >
          <div className="formHeader">
            <h3>Edit Fire Report {`${fire.callNumber}`}</h3>
          </div>
          <div
            style={{
              margin: "3rem"
            ...
            <Formik
              ...
              onSubmit={(values, { setSubmitting }) => {
                ...
                axios
                  ...
                  : REACT_APP_API_URL_DEV}/updateFire`, values)
                ...
                return (
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="row u-no-wrap">
                      <div className="col-3">
                        <label htmlFor="callNumber" className="font-extrabold">
                          Call Number
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="col-3">
                        <label htmlFor="stationArea" className="font-extrabold">
                          Station Area
                        </label>
                        <div className="row u-no-wrap">
                          <div>
                    ...
                    <div className="row u-no-wrap">
                        ...
                        <div className="row u-no-wrap">
                          <div>
                            <input
                              ...
                              onBlur={handleBlur}
                              value="Cellphone"
                              checked={values.methodOfReporting === "Cellphone"}
                            />
                            ...
                            <input
                              ...
                              onBlur={handleBlur}
                              value="Telephone"
                              checked={values.methodOfReporting === "Telephone"}
                            />
                        ...
                        <div className="row u-no-wrap">
                          <div>
                            <input
                              ...
                              onBlur={handleBlur}
                              value="OFF SCENE"
                              checked={values.locationOfCaller === "OFF SCENE"}
                            />
                      ...
                      <div className="col-3">
                        <label htmlFor="callerName" className="font-extrabold">
                          Caller Name
                        </label>
                        <input
                          type="text"
                    ...
                    <div className="row u-no-wrap">
                      <div className="col-2">
                        {" "}
                        <label htmlFor="timeCalled" className="font-extrabold">
                          Time Called
                        </label>
                        <input
                          type="time"
                    ...
                    <div className="row u-no-wrap">
                      <div className="col-4">
                        {" "}
                        <label htmlFor="typeOfFire" className="font-extrabold">
                          Type Of Fire
                        </label>
                        <Select
                          allowClear
                      ...
                      <div className="col-4">
                        {" "}
                        <label htmlFor="otherTypes" className="font-extrabold">
                          Other Types
                        </label>
                        <input
                          type="text"
                    ...
                    <div className="row u-no-wrap">
                      <div className="col-3">
                        <label htmlFor="nameOfOwner" className="font-extrabold">
                          Name Of Owner
                        </label>
                        <input
                          type="text"
