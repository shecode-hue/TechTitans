...
const scienceEventsslider = [
  {
    ...
    description: "Join us for a symposium on the latest developments in physics research.",
  },
  {
    image: Slider2,
  ...
  },
  {
    ...
    description: "Discover the wonders of the universe with our astronomy lecture series.",
  },
  {
    image: Slider2,
    title: "Environmental Science Seminar",
    description: "Learn about environmental conservation and sustainability at our seminar.",
  },
  {
    image: Slider3,
    title: "Science Fair",
    description: "Showcase your science projects and innovations at our annual science fair.",
  },
];
const scienceEvents = [
  {
...
const Homepage = () => {
  ...
  const dateCellRender = (value) => {
    const eventsForDate = scienceEvents.filter((event) => {
      ...
      return eventDate.getDate() === value.date() && eventDate.getMonth() === value.month();
    });
  ...
  return (
    <div className="slider-container">
        ...
        {scienceEventsslider.map((event, index) => (
          <div className="slide-item" key={index}>
            ...
            <div className="slide-content">
              ...
              <div className="button-container"><div className = "pulse-button"> 
      ...
      <div className="button-container">
        <button className="pulse-button">Book an event</button>
      </div>
